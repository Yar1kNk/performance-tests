...
class OpenSavingsAccountResponseDict:
    """
...
class OpenDebitCardAccountResponseDict:
    """
...
class OpenCreditCardAccountResponseDict:
    """
    Описание структуры ответа открытия дебетового счета.
    """
    account: AccountDict
...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    def get_accounts(self, user_id: str) -> GetAccountResponseDict:
